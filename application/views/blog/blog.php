...
<div class="wrap">
	<div class="main">
		<div class="content">
			<div class="blog_left">		
				<div class="blog_main">	
					<img src="<?php echo base_url().'assets/detail/images/blog_pic1.jpg';?>" alt=""/>
					<div class="b_left">
						<h4 class="bg"><img src="<?php echo base_url().'assets/detail/images/note.jpg';?>" alt=""/></h4>
					</div>
					<div class="b_right">
	...
	<div class="blog_main">	
		<div class="our-mission" id="team">
			...
			<script type="text/javascript" src="<?php echo base_url().'assets/detail/js/jquery.mousewheel.js';?>"></script>
			<script type="text/javascript" src="<?php echo base_url().'assets/detail/js/jquery.contentcarousel.js';?>"></script>
					...
					<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						...
						<div class="resp-tabs-container">
						    ...
						    <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
								<div class="facts">
									<ul class="tab-left">
										<span class="tab-img"><img src="<?php echo base_url().'assets/detail/images/tab_pic1.jpg';?>" alt=""/></span>
											<div class="tab-text">
									...
									<ul class="tab-left">
										<span class="tab-img"><img src="<?php echo base_url().'assets/detail/images/tab_pic2.jpg';?>" alt=""/></span>
											<div class="tab-text">
						     ...
						     <div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
							 	<div class="facts">
									<ul class="tab-left">
										<span class="tab-img"><img src="<?php echo base_url().'assets/detail/images/tab_pic5.jpg';?>" alt=""/></span>
											<div class="tab-text">
												<p><a href="#">Lorem ipsum dolor sitsah.</a></p>
												<div class="post-meta">
												   <img src="images/date.png" alt=""><a href="#" class="date"> 21 March 2013</a>
					    	...
					    	<div class="tab-3 resp-tab-content" aria-labelledby="tab_item-2">
								<div class="facts">
									<ul class="tab-left">
										<span class="tab-img"><img src="<?php echo base_url().'assets/detail/images/tab_pic3.jpg';?>" alt=""/></span>
											<div class="tab-text">
												<p><a href="#">Lorem ipsum dolor sitsah.</a></p>
												<div class="post-meta">
												   <img src="images/date.png" alt=""><a href="#" class="date"> 21 March 2013</a>
						...
						<script src="<?php echo base_url().'assets/detail/js/jquery.min.js';?>"></script>
						<script src="<?php echo base_url().'assets/detail/js/easyResponsiveTabs.js';?>" type="text/javascript"></script>
					    <script type="text/javascript">
